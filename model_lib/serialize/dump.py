...
def dump_as_toml_str(instance: object, multiline_strings: bool = False, **kwargs) -> str:
    compact = dump_as_toml_str_compact(instance, multiline_strings=multiline_strings, **kwargs)
    return add_line_breaks(compact)


def dump_as_toml_str_compact(instance: object, multiline_strings: bool = False, **kwargs) -> str:
